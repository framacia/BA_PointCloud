...
namespace BAPointCloudRenderer.CloudController {
    ...
    /// </summary>
    public class DynamicPointCloudSetCR : AbstractPointCloudSetCR {
        /// <summary>
        ...
        protected override void Initialize() {
            ...
            PointRenderer = new V2RendererCR(this, minNodeSize, pointBudget, nodesLoadedPerFrame, nodesGOsPerFrame, userCamera, meshConfiguration, cacheSizeInPoints);
        }
        ...
        void Update() {
            ...
            //Debug.Log("CURRENT SHOWN POINTS: " + PointRenderer.GetPointCount());
        }
    }
}
