...
namespace BAPointCloudRenderer.Loading
{
    ...
    class V2TraversalThread
    {
        ...
        /// </summary>
        public V2TraversalThread(GameObject parent, V2Renderer mainThread, V2LoadingThread loadingThread,
            List<Node> rootNodes, double minNodeSize, uint pointBudget, uint nodesLoadedPerFrame, uint nodesGOsPerFrame,
            V2Cache cache)
        {
            this.parent = parent;
